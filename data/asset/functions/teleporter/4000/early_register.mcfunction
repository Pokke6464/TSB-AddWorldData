#> asset:teleporter/4000/early_register
#
#
#
...
# ID (int)
    data modify storage asset:teleporter Teleporters[-1].ID set value 4000
# Dimension (string[minecraft:dimension])
    data modify storage asset:teleporter Teleporters[-1].Data.Dimension set value "minecraft:the_nether"
# Pos ([int] @ 3)
    data modify storage asset:teleporter Teleporters[-1].Data.Pos set value [3, 99, 77]
# GroupIDs ([string])
    data modify storage asset:teleporter Teleporters[-1].Data.GroupIDs set value ["test"]
